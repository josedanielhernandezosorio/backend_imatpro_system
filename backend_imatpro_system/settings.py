...
SECRET_KEY = 'django-insecure-ybjqskfu1t0j9q8csuoqub+rowm832pl(@vd#mw137wzo%e%7-'
...
INSTALLED_APPS = [
    ...
    'com.sofyntelligen.imapross.backend.equation.firstdegree.apps.FirstdegreeConfig',
]
