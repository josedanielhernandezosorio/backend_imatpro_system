...
class CharacterListAPI(APIView, api_settings.DEFAULT_PAGINATION_CLASS):
    ...
    def post(self, request):
        ...
        for character in character_list:
            mathML2Tex, asciiMath2MathML = get_view_math(character['view'])
            character['latex_math'] = mathML2Tex
            character['math_ml'] = asciiMath2MathML
...
class CharacterAPI(APIView):
    ...
    def post(self, request, pk):
        mathML2Tex, asciiMath2MathML = get_view_math(request.data['view'])
