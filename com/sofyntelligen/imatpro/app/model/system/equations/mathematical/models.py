...
class Character(models.Model):
    ...
    view = models.CharField(_('view'), blank=True, null=True)
...
class Equation(models.Model):
    ...
    view = models.CharField(_('equation'), null=True)
    latex_define = models.CharField(_('latex'), null=True)
    ...
    type_representation = models.CharField(_('type'), null=True)
